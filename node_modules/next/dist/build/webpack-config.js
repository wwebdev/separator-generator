...
res.match(/node_modules[/\\]@babel[/\\]runtime[/\\]/)||!config.experimental.polyfillsOptimization&&res.match(/node_modules[/\\]@babel[/\\]runtime-corejs2[/\\]/))){return callback();}// Webpack itself has to be compiled because it doesn't always use module relative paths
...
annotation:false}}})].filter(Boolean)},context:dir,// Kept as function to be backwards compatible
