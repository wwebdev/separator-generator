"use strict";exports.__esModule=true;exports.default=exports.pluginLoaderOptions=void 0;var _querystring=require("querystring");var _collectPlugins=require("../../plugins/collect-plugins");const pluginLoaderOptions={plugins:[]};exports.pluginLoaderOptions=pluginLoaderOptions;const nextPluginLoader=function(source){const{middleware}=typeof this.query==='string'?(0,_querystring.parse)(this.query.substr(1)):this.query;const plugins=pluginLoaderOptions.plugins.filter(plugin=>{return plugin.middleware.includes(middleware);});const pluginIds=[];const pluginConfigs=[];return`
